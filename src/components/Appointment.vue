<template>
  <div class="min-h-screen bg-blue-50 py-10 px-4">
    <div class="max-w-4xl mx-auto bg-white p-8 rounded-xl shadow-md">
      <h2 class="text-3xl font-bold text-blue-700 text-center mb-6">Book an Appointment</h2>
...
import {getLoggedInUser, setAppointment} from "@/lib/helper.js";
...
form.value.doctor = url.get('doctor') || ''
